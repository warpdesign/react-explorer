    ...
    private hotkeys = [
        {
            global: true,
            combo: 'mod + o',
            label: this.injected.t('SHORTCUT.ACTIVE_VIEW.OPEN_FILE'),
        ...
        },
        {
            global: true,
            combo: 'mod + i',
            label: this.injected.t('SHORTCUT.ACTIVE_VIEW.SELECT_INVERT'),
            ...
            ? [
                  {
                      global: true,
                      combo: 'mod + a',
                      label: this.injected.t('SHORTCUT.ACTIVE_VIEW.SELECT_ALL'),
